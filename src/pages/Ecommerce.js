        ...
        <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center'>
          <div className='flex justify-between items-center'>
            <div>
              ...
              <p className='text-2xl'>$65,444,88</p>
            </div>
          </div>
          <div className='mt-6'>
            <Button
        ...
        <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780'>
          ...
          <div className='mt-10 flex gap-10 flex-wrap justify-center'>
            <div className='border-r-1 border-color m-4 pr-10'>
              <div>
                <p>
                  <span className='text-3xl font-semibold'>$54,458</span>
              ...
              <div className='mt-8'>
                <p>
                  <span className='text-3xl font-semibold'>$74,458</span>
                </p>
            ...
            <div>
              <Stacked width='320pxh' height='360px' />
            </div>
          </div>
        </div>
      </div>
